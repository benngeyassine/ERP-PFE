...
import { SalesListToolbar } from "./sales-list-toolbar";
...
const rows = [
  createData("SI005", "2022-06-12", "hadi jllali", "21546852", "5"),
  createData("SI004", "2022-06-09", "othmane hamami", "98753951", "3"),
  createData("SI003", "2022-06-06", "seif zaraa", "55623874", "4"),
  createData("SI002", "2022-06-03", "tawfik belhady", "25654987", "2"),
  createData("SI001", "2022-06-02", "majdi hrayzy", "21586479", "5"),
];
const Sales = () => {
  const [open, setOpen] = React.useState(false);
